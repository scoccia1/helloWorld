...
with app.app_context():
    ...
    # Initial loading of students first_name, last_name, major_id, birth_date, is_honors. Add email to previous entries
    students = [
...
## Return email for each student in the database
