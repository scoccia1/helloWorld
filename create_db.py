...
with app.app_context():
    ...
    # Initial loading of Users information
    # Create user and password for scoccia
    users = [
        ...
        {'username': 'scoccia', 'email': 'scoccia@terpmail.umd.edu', 'first_name': 'Sami', 'last_name': 'Coccia',
         'password': generate_password_hash('scoccia', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
